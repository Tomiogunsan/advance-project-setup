...
const onChange = (e: React.ChangeEvent<HTMLInputElement>) => { setForm((_form) => ({
..._form,
...
onSuccess: () => { queryClient.invalidateQueries('top-quotes') 
...
return (
  <div className='py-8 max-w-2xl mx-auto'>
    ...
    <form onSubmit={onSubmit} className='space-y-6 max-w-lg mx-auto text-left'>
