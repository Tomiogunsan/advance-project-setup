...
const QueryCancellation = () => {
  ...
  const {
    ...
    () => {
      ...
      // It is initialised with a noop, because of TypeScript Control Flow Analysis // We can't assign the abort method on the `promise` variable directly, because // it can't be accessed before it is fully initialised.
